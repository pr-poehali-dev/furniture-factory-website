...
const CATALOG = [
  {
    ...
    desc: "Производим диваны прямые, угловые. Каркас — собственный металл, ДСП (ЛДСП), ткань — фирменная рогожка, велюр. Подходят для жилых и коммерческих пространств.",
    features: ["Металлокаркас собственного производства", "Ткань-рогожка или велюр", "Прямые и угловые конфигурации", "Разнообразие модельного ряда"],
  },
  {
    ...
    desc: "Кресла для дома, переговорных и лобби. Широкая линейка форм: классика, скандинавский стиль, мягкий минимализм.",
    features: ["Пластиковые опоры собственного производства", "Лаконичный и современный дизайн", "Средняя жёсткость сидений", "Базовые и раскладные модели"],
  },
  {
    ...
    desc: "Кровати с мягким изголовьем из велюра. Разные размеры: 90, 140, 160, 180 см. Высокое изголовье обеспечивает комфортный отдых. На мягкую спинку удобно облокотиться, чтобы почитать перед сном.",
    features: ["Размеры 90 / 140 / 160 / 180 см", "Изголовье — ткань", "Вариант с подъёмным механизмом", "Каркас — ДСП"],
  },
  {
    ...
    desc: "Комплекты для террас, веранд и загородных домов. Лоза — собственное производство. Устойчива к ультрафиолетовому излучению, морозу и влаге.",
    features: ["Лоза собственного производства", "Устойчивость к ультрафиолету и морозостойкость", "Металлический каркас собственного производства", "Комплекты и отдельные предметы"],
  },
  {
    ...
    features: ["Искусственный ротанг", "Металлический каркас-подставка", "Для улицы и интерьера", "Хит продаж 2026"],
  },
  {
